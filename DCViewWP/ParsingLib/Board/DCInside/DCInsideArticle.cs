...
namespace DCView.Board
{
    public class DCInsideArticle : IArticle
    {
        ...
        {
            return board.GetArticleText(this, out text);
        }

        public bool WriteComment(string text)
        {
            return board.WriteComment(this, text);
        }
        ...
        class CommentLister : ILister<IComment>
        {
            ...
            public bool Next(out IEnumerable<IComment> elems)
            {
                elems = null;
